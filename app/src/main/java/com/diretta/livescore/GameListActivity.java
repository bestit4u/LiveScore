...
public class GameListActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mProgDlg = new ProgressDialog(GameListActivity.this);
        ...
        RnFeed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_home = new Intent(GameListActivity.this, FeedActivity.class);
        ...
        RnCalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_classify = new Intent(GameListActivity.this, LivescoreActivity.class);
        ...
        RnTip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_classify = new Intent(GameListActivity.this, TipsActivity.class);
                intent_classify.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent_classify);
            }
        });
        ...
        RnProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent_login = new Intent(GameListActivity.this, ProfileActivity.class);
    ...
    private Handler mLoadHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                Toast.makeText(GameListActivity.this, "There is no data", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(GameListActivity.this, "Network error!", Toast.LENGTH_SHORT).show();
            }
    ...
    private void bindData(){
        ...
        for (int i = 0; i < Common.getInstance().arrDateList.size(); i++) {
            final View v1 = LayoutInflater.from(GameListActivity.this).inflate(R.layout.layout_league, null);
            ...
            for (int j = 0; j < Common.getInstance().arrGameListInfo.size(); j++) {
                ...
                if (arrStart[0].equals(Common.getInstance().arrDateList.get(i))) {
                    final View v2 = LayoutInflater.from(GameListActivity.this).inflate(R.layout.popular_item, null);
                    ...
                    date = new Date();
                    try {
                        date = sdformat.parse(Common.getInstance().arrGameListInfo.get(j).time);
