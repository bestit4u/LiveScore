...
package com.diretta.livescore.util;
...
public class IabHelper {
    ...
    public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
        ...
        try {
            ...
            int r = queryPurchases(Common.getInstance().inv, ITEM_TYPE_SUBS);
    ...
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreItemSkus,
        ...
        (new Thread(new Runnable() {
            public void run() {
                ...
                Common.getInstance().inv = null;
                try {
                    Common.getInstance().inv = queryInventory(querySkuDetails, moreItemSkus, moreSubsSkus);
                }
                ...
                final Inventory inv_f = Common.getInstance().inv;
    ...
    public void queryInventoryAsync(QueryInventoryFinishedListener listener)
        ...
        arrList.add("ba.week");
        arrList.add("ba.month");
        arrList.add("ba.6months");
        arrList.add("ba.year");
        queryInventoryAsync(true, arrList, null, listener);
    }
