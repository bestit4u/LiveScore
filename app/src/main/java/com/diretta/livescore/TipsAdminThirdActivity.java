...
public class TipsAdminThirdActivity extends Activity {
    String mEvent_id = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tip_admin_third);
        mProgDlg = new ProgressDialog(TipsAdminThirdActivity.this);
    ...
    private Handler mLoadHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                Toast.makeText(TipsAdminThirdActivity.this, "There is no data", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(TipsAdminThirdActivity.this, "Network error!", Toast.LENGTH_SHORT).show();
            }
    ...
    private void bindData() {
        ...
        if (!Common.getInstance().gameDetailInfo.home_odd.equals("")) {
            final View vFullTimeResult = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.full_time_result, null);
            ...
            lnHomeOdd.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    TipResultDialog tipResultDialog = new TipResultDialog(TipsAdminThirdActivity.this);
        ...
        if (!Common.getInstance().gameDetailInfo.double_chance_12.equals("")) {
            final View vDoubleChance = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.double_chance, null);
        ...
        if (!Common.getInstance().gameDetailInfo.total_goal_over.equals("")) {
            final View vTotalGoals = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.total_goals, null);
        ...
        if (!Common.getInstance().gameDetailInfo.bts_yes.equals("0")) {
            final View vBTS = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.both_team_score, null);
        ...
        if(!Common.getInstance().gameDetailInfo.asian_home_odd.equals("")) {
            final View vAsianHandicap = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.asian_handicap, null);
        ...
        if(!Common.getInstance().gameDetailInfo.goal_line_under.equals("")) {
            final View vGoalLine = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.goal_line, null);
        ...
        */
        ...
        if (Common.getInstance().arrCorrectScores.size() > 0) {
            final View vCorrectScore = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.correct_score, null);
            ...
            if ((mArrHomescores.size() >= mArrDrawScores.size()) && (mArrHomescores.size() >= mArrAwayScores.size())) {
                for (int i = 0; i < mArrHomescores.size(); i++) {
                    ...
                    final View vCorrectScoreItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.correct_score_item, null);
        ...
        if (Common.getInstance().arrAlternativeTotalGoals.size() > 0) {
            final View vAlternativeTotalGoals = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.alternative_total_goal, null);
            ...
            for (int i = 0; i < Common.getInstance().arrAlternativeTotalGoals.size(); i++) {
                ...
                final View vAlternativeTotalGoalsItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.alternative_total_goal_item, null);
        ...
        if (Common.getInstance().arrExactTotalGoals.size() > 0) {
            final View vExactTotalGoals = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.exact_total_goal, null);
            ...
            for (int i = 0; i < Common.getInstance().arrExactTotalGoals.size(); i++) {
                ...
                final View vExactTotalGoalsItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.exact_total_goal_item, null);
        ...
        if (Common.getInstance().arrTeamTotalGoals.size() > 0) {
            final View vTeamTotalGoals = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.team_total_goals, null);
            ...
            for (int i = 0; i < arrHandicap.size(); i++) {
                ...
                final View vTeamTotalGoalsItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.team_total_goals_item, null);
        ...
        if (Common.getInstance().arrMatchTotalGoals.size() > 0) {
            final View vMatchTotalGoals = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.match_total_goal, null);
            ...
            for (int i = 0; i < Common.getInstance().arrMatchTotalGoals.size(); i++) {
                ...
                final View vMatchTotalGoalsItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.match_total_goal_item, null);
        ...
        if (Common.getInstance().arrTotalGoalsBTS.size() > 0) {
            final View vTotalGoalsBTS = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.total_goal_bts, null);
            ...
            for (int i = 0; i < Common.getInstance().arrTotalGoalsBTS.size(); i++) {
                ...
                final View vTotalGoalsBTSItem = LayoutInflater.from(TipsAdminThirdActivity.this).inflate(R.layout.total_goal_bts_item, null);
    ...
    private TipResultDialog.OnCancelOrderListener mTipResultListener = new TipResultDialog.OnCancelOrderListener() {
        ...
        public void OnCancel(String strReason) {
            ...
            Common.getInstance().mTip = "1";
            Common.getInstance().mTipDictionary = new PlacedTipInfo(Common.getInstance().gameDetailInfo.event_id, Common.getInstance().gameDetailInfo.home, Common.getInstance().gameDetailInfo.away, Common.getInstance().gameDetailInfo.start_date_time, Common.getInstance().gameDetailInfo.league_name, mSelectedMarketStyle, mSelectedOddStyle, mSelectedOdd, mTipAmount, Common.getInstance().gameDetailInfo.home_image, Common.getInstance().gameDetailInfo.away_image, "");
            Intent intent = new Intent(TipsAdminThirdActivity.this, CreateTipOfDayActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
            startActivity(intent);
            TipsAdminThirdActivity.this.finish();
        }
    };
}
